...
import org.qa.light.session13.steps.DBSteps;
import org.qa.light.session13.steps.DBStepsV2;
import org.qa.light.session13.steps.WebSteps;
...
@CucumberOptions(
        tags = "@wip",
        glue = "org.qa.light.session13.steps",
        features = "src/test/resources/features/demo",
        plugin = {
                "pretty"
//                , "org.qa.light.session13.CucumberHooks"
        }
)
